...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=12345&box=10.450255,47.519056,10.184223,47.339393
...
-----------
  ...
  * 12345 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * 12345 Height Map (SRTM3 v4.1).png
  ...
  * 12345 Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 723m (actual) is equal to 40m in
